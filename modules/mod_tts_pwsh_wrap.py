# Auto-generated wrapper (FIXED) for tts_pwsh
# - No dependency on module_api
# - Avoids blueprint collisions by checking existing routes first
# - Registers /api/mod/tts_pwsh/health ONLY if missing
# - Always exposes /api/mod/tts_pwsh/wrap/health for debugging
...
def _try_import_underlying():
    ...
    target = os.path.join(here, f"tts_pwsh.py")
