# Auto-generated wrapper (FIXED) for audio_vad
# - No dependency on module_api
# - Avoids blueprint collisions by checking existing routes first
# - Registers /api/mod/audio_vad/health ONLY if missing
# - Always exposes /api/mod/audio_vad/wrap/health for debugging
...
def _try_import_underlying():
    ...
    target = os.path.join(here, f"audio_vad.py")
