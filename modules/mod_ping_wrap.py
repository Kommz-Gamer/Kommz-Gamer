# Auto-generated wrapper (FIXED) for ping
# - No dependency on module_api
# - Avoids blueprint collisions by checking existing routes first
# - Registers /api/mod/ping/health ONLY if missing
# - Always exposes /api/mod/ping/wrap/health for debugging
...
def _try_import_underlying():
    ...
    target = os.path.join(here, f"ping.py")
