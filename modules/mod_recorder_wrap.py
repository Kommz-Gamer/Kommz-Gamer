# Auto-generated wrapper (FIXED) for recorder
# - No dependency on module_api
# - Avoids blueprint collisions by checking existing routes first
# - Registers /api/mod/recorder/health ONLY if missing
# - Always exposes /api/mod/recorder/wrap/health for debugging
...
def _try_import_underlying():
    ...
    target = os.path.join(here, f"recorder.py")
