# Auto-generated wrapper (FIXED) for tts_edge
# - No dependency on module_api
# - Avoids blueprint collisions by checking existing routes first
# - Registers /api/mod/tts_edge/health ONLY if missing
# - Always exposes /api/mod/tts_edge/wrap/health for debugging
...
def _try_import_underlying():
    ...
    target = os.path.join(here, f"tts_edge.py")
