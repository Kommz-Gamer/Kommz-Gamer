# Auto-generated wrapper (FIXED) for ux_hotkeys
# - No dependency on module_api
# - Avoids blueprint collisions by checking existing routes first
# - Registers /api/mod/ux_hotkeys/health ONLY if missing
# - Always exposes /api/mod/ux_hotkeys/wrap/health for debugging
...
def _try_import_underlying():
    ...
    target = os.path.join(here, f"ux_hotkeys.py")
