# Auto-generated wrapper (FIXED) for util_sync
# - No dependency on module_api
# - Avoids blueprint collisions by checking existing routes first
# - Registers /api/mod/util_sync/health ONLY if missing
# - Always exposes /api/mod/util_sync/wrap/health for debugging
...
def _try_import_underlying():
    ...
    target = os.path.join(here, f"util_sync.py")
