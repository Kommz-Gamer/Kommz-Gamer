# Auto-generated wrapper (FIXED) for mt_deepl
# - No dependency on module_api
# - Avoids blueprint collisions by checking existing routes first
# - Registers /api/mod/mt_deepl/health ONLY if missing
# - Always exposes /api/mod/mt_deepl/wrap/health for debugging
...
def _try_import_underlying():
    ...
    target = os.path.join(here, f"mt_deepl.py")
