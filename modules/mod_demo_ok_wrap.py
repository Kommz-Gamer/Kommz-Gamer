# Auto-generated wrapper (FIXED) for demo_ok
# - No dependency on module_api
# - Avoids blueprint collisions by checking existing routes first
# - Registers /api/mod/demo_ok/health ONLY if missing
# - Always exposes /api/mod/demo_ok/wrap/health for debugging
...
def _try_import_underlying():
    ...
    target = os.path.join(here, f"demo_ok.py")
